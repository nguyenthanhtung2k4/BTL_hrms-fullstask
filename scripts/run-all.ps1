...
Write-Host "Gateway HR: http://localhost:5000/api/hr/info"
Write-Host "Gateway Attendance: http://localhost:5000/api/attendance/info"
Write-Host "Gateway Payroll: http://localhost:5000/api/payroll/info"
